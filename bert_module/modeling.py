...
# code is from https://github.com/bert-nmt/bert-nmt/blob/master/bert/modeling.py
...
class BertSelfOutput(nn.Module):
    ...
    def forward(self, hidden_states, input_tensor):
        ...
        # 经过 dense 后 的 hidde_states 最低维度的尺寸： config.hidden_size ，
        # 其中 hidden_dropout_prob * hidden_size 个 neuron 置为0，其他neuron值放大
...
class BertLayer(nn.Module):
    def __init__(self, config):
        ...
        # feedforward + activate (gelu)
        self.intermediate = BertIntermediate(config)
        # inter-size back to model size
...
class BertModel(BertPreTrainedModel):
    ...
    def forward(self, input_ids, token_type_ids=None, attention_mask=None, output_all_encoded_layers=True):
        ...
        # Sizes are [batch_size, 1, 1, to_seq_length]  ex: [4,1,1,7]
